...
public class WalletApp3DbContext :
    AbpDbContext<WalletApp3DbContext>,
    ...
    IIdentityDbContext
{
    ...
    public WalletApp3DbContext(DbContextOptions<WalletApp3DbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(WalletApp3Consts.DbTablePrefix + "YourEntities", WalletApp3Consts.DbSchema);
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(WalletApp3Consts.DbTablePrefix + "PaymentTypeCategories", WalletApp3Consts.DbSchema);
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(WalletApp3Consts.DbTablePrefix + "BillDetails", WalletApp3Consts.DbSchema);
                b.ConfigureByConvention();
